...
- Format citations inline as [cited text]{url} where url is a full URL (https://...) or DOI URL (https://doi.org/...). Example: [weight loss of 24%]{https://doi.org/10.1056/NEJMoa2301972}. Do not use markdown link syntax for citations.
