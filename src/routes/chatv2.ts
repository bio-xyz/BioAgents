...
/**
 * Chat V2 Route - Agent-based architecture
 */
const chatV2RoutePlugin = new Elysia()
  .use(
    smartAuthMiddleware({
      optional: true,
    }),
...
export const chatV2RouteGet = chatV2RoutePlugin.get(
  "/api/chat-v2",
  async () => {
    return {
...
export const chatV2Route = chatV2RoutePlugin.post(
  "/api/chat-v2",
  async (ctx) => {
    try {
      const {
      ...
      logger.info(
        ...
        "chat_v2_completed_successfully",
      );
