...
import { x402ResearchRoute, x402ResearchRouteGet } from "./research";

/**
 * Unit tests for x402 Research Route
 *
...
describe("x402 Research Route", () => {
  let app: Elysia;

  beforeAll(() => {
    app = new Elysia()
      .use(x402ResearchRouteGet)
      .use(x402ResearchRoute);
  });
  ...
  describe("GET /api/x402/research - Discovery", () => {
  ...
  describe("POST /api/x402/research - Validation", () => {
  ...
  describe("POST /api/x402/research - Request Format", () => {
  ...
  describe("POST /api/x402/research - Error Messages", () => {
    ...
    test("should include descriptive error message for missing message", async () => {
      const response = await app.handle(
        new Request("http://localhost/api/x402/research", {
          method: "POST",
          headers: {
