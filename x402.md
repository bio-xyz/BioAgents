...
### 1. Authentication Setup (for whitelisted users)

```bash
# Privy Authentication (Next.js frontend - bypasses x402)
...
Get Privy credentials from [Privy Dashboard](https://dashboard.privy.io/).
