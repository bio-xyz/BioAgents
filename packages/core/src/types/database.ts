...
export interface IDatabaseAdapter {
  ...
  addNewInternalKnowledgeEntry(wallet: string, hasInternalKnowledge: boolean): Promise<void>;
  hasInternalKnowledge(wallet: string): Promise<boolean>;

  // Answer evaluation operations
  createAnswerEval(data: {
    messageId?: string;
    channelId: string;
    agentId: string;
    senderId: string;
  ...
  updateAnswerEval(messageId: string, updates: {
    answer?: string;
    knowledgeChunks?: any[];
    knowledgeGraphChunks?: any[];
    knowledgeGraphSynthesis?: string;
